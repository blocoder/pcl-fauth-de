 ...
 */
function pcl_fluentauth_de_map_eintraege() {
    return array(
        ' or ' => ' oder ',
...
function pcl_fluentauth_de_map_ergaenzen($vars) {
    ...
    foreach (pcl_fluentauth_de_map_eintraege() as $schluessel => $text) {
...
add_filter('fluent_security/app_vars', 'pcl_fluentauth_de_map_ergaenzen', 20);
