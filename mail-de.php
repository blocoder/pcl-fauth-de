 ...
 */
function pcl_fluentauth_de_code_entschaerfen($html) {
 ...
 */
function pcl_fluentauth_de_head_ergaenzen($html) {
...
function pcl_fluentauth_de_mail_korrigieren($atts) {
    ...
    if ($code) {
        $html = pcl_fluentauth_de_code_entschaerfen($html);
        $html = pcl_fluentauth_de_head_ergaenzen($html);
    }

    $atts['message'] = $html;
    return $atts;
}
add_filter('wp_mail', 'pcl_fluentauth_de_mail_korrigieren', 20);
